                  ...
                  <div key={item.name}>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        sidebarCollapsed ? "lg:justify-center lg:px-3 px-4 py-3" : "px-4 py-3 justify-between",
                        hasActiveChild ? "text-slate-900" : "text-slate-600 hover:text-slate-900"
                      )}
                      style={{
                        backgroundColor: hasActiveChild ? `${colors.primary}10` : undefined,
                      }}
                      onMouseEnter={(e) => {
                        if (!hasActiveChild) {
                    ...
                    >
                      ...
                      {!sidebarCollapsed && (
                        <ChevronDown className={cn(
                          "w-4 h-4 transition-transform duration-200 lg:block hidden",
                          isOpen && "transform rotate-180"
                        )} />
                      )}
                      <ChevronDown className={cn(
                        "w-4 h-4 transition-transform duration-200 lg:hidden",
                        isOpen && "transform rotate-180"
                      )} />
                    </button>
                    ...
                    {isOpen && (
                      <div className={cn(
                        ...
                        sidebarCollapsed ? "lg:hidden" : "pl-4"
                      )}>
                        {item.children.map((child) => {
                          ...
                          return (
                            <Link
                              ...
                              to={child.href}
                              className={cn(
                                "flex items-center gap-3 rounded-lg text-sm font-medium transition-all duration-200 px-4 py-2.5"
                              )}
                              style={{
                                backgroundColor: isActive ? colors.primary : undefined,
                                color: isActive ? "white" : undefined,
                                boxShadow: isActive ? "0 2px 4px -1px rgb(0 0 0 / 0.1)" : undefined,
                              }}
                              onMouseEnter={(e) => {
                                if (!isActive) {
